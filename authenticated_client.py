...
class AuthenticatedClient(PublicClient):
    ...
    """
    def __init__(self, api_url="https://api.pro.coinbase.com"):  #https://api.pro.coinbase.com
    ...
    def get_agents_offer(self):
        offer = ml.run_agent()
        if offer[1] == 'buy' or offer[1] == 'sell':
            self.place_limit_order(product_id=offer[0], side=offer[1], price=offer[2], size=offer[3],
                                   time_in_force=offer[4], cancel_after=offer[5])
